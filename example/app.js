  ...
  function ($scope, $state, $log) {
    $scope.$on('gsapifyRouter:enterStart', function (event, element) {
      if ($state.history.length) {
        $log.log(
          'gsapifyRouter:enterStart',
          element.attr('ui-view'),
...
angular.module('HomeCtrl', []).controller('HomeCtrl', [
  '$scope',
  '$log',
  function ($scope, $log) {
    $scope.$on('gsapifyRouter:enterSuccess', function (event, element) {
...
angular.module('Page1Ctrl', []).controller('Page1Ctrl', [
  '$scope',
  '$log',
  function ($scope, $log) {
    $scope.$on('gsapifyRouter:enterSuccess', function (event, element) {
...
angular.module('Page2Ctrl', []).controller('Page2Ctrl', [
  '$scope',
  '$log',
  function ($scope, $log) {
    $scope.$on('gsapifyRouter:enterSuccess', function (event, element) {
...
angular.module('Page3Ctrl', []).controller('Page3Ctrl', [
  '$scope',
  '$log',
  function ($scope, $log) {
    $scope.$on('gsapifyRouter:enterSuccess', function (event, element) {
